...
export const en: SameShape<typeof es> = {
  ...
  courseTeeSelect: {
    ...
    noResultsContactPrefix: "Can't find your course? ",
    noResultsContactLinkText: 'Contact us',
    noResultsContactSuffix: " and we'll have it available in less than 30 minutes.",
    ...
    distance: 'Distance',
    filterAll: 'All',
    filterFront: 'Front 9 (1-9)',
    filterBack: 'Back 9 (10-18)',
    scorecardTotals: 'Total',
  },
  contact: {
    title: 'Contact',
